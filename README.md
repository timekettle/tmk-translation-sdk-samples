...
Tmk Translation SDK 是时空壶统一的实时语音翻译能力封装，为开发者提供了一套全链路的语音翻译解决方案。该 SDK 整合了 **语音识别（ASR）** 、 **机器翻译（MT/LLM）** 和 **文本转语音（TTS）** 三大核心能力，支持在 Android 和 iOS 平台上快速集成，实现高质量的实时语音翻译功能。
...
![截屏2026\-04\-21 09\.09\.43\.png](Assets/截屏2026-04-21%2009.09.43.png)

- iOS

![截屏2026\-04\-21 09\.10\.29\.png](Assets/截屏2026-04-21%2009.10.29.png)
