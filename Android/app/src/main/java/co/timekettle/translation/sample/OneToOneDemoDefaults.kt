...
import co.timekettle.translation.enums.TmkChannelAudioMode
...
/** Demo 界面保留历史单声道/立体声选项，接入 SDK 时统一转换为跨端通道音频模式。 */
internal fun TmkOfflineAudioChannelMode.toChannelAudioMode(): TmkChannelAudioMode = when (this) {
    TmkOfflineAudioChannelMode.STEREO -> TmkChannelAudioMode.STANDARD
    TmkOfflineAudioChannelMode.MONO -> TmkChannelAudioMode.LOW_LATENCY
}
