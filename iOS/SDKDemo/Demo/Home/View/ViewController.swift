...
final class ViewController: UIViewController {
    ...
    private func presentLanguagePicker(title: String,
                                       selectedCode: String?,
                                       selectionHandler: @escaping (DemoLanguageOption) -> DemoHomeLanguageSelectionResult) {
        let controller = DemoLanguagePickerViewController(title: title,
                                                          options: state.languages,
                                                          selectedCode: selectedCode,
                                                          onConfirm: { option in
                                                              selectionHandler(option).pickerMessage
                                                          })
    ...
    @objc private func onChangeSourceLanguage() {
        ...
        presentLanguagePicker(title: "选择源语言",
            ...
            guard let self else { return .applied }
            return self.viewModel.selectSourceLanguage(option)
        }
    }
    ...
    @objc private func onChangeTargetLanguage() {
        ...
        presentLanguagePicker(title: "选择目标语言",
            ...
            guard let self else { return .applied }
            return self.viewModel.selectTargetLanguage(option)
        }
    }
